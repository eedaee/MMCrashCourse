...
/* USER CODE BEGIN PV */
// Public variables so they can be watched in Debug -> Live Expressions.
uint16_t dis_FL = 0;
uint16_t dis_FR = 0;
uint16_t dis_L = 0;
uint16_t dis_R = 0;
...
//static void ADC1_Select_Channel(uint32_t channel)
//{
//    ADC_ChannelConfTypeDef sConfig = {0};
//
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, ML_FWD_Pin|RED_LED_Pin|BLUE_LED_Pin|GREEN_LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ML_FWD_Pin RED_LED_Pin BLUE_LED_Pin GREEN_LED_Pin */
  GPIO_InitStruct.Pin = ML_FWD_Pin|RED_LED_Pin|BLUE_LED_Pin|GREEN_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : BUTTON_Pin BUTTON_3_Pin */
  GPIO_InitStruct.Pin = BUTTON_Pin|BUTTON_3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
